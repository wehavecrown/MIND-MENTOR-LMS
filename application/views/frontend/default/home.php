                ...
                <div class="home-banner-wrap">
                    ...
                    <form class="" action="<?php echo site_url('home/search'); ?>" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control" name = "query" placeholder="<?php echo get_phrase('what_do_you_want_to_learn_today'); ?>?">
...
<section class="home-fact-area">
    <div class="container-lg">
        <div class="row">
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        ...
                        <p><?php echo get_phrase('explore_a_wide_variety_of_expertly_crafted_courses'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    <i class="fa fa-user-tie float-left"></i>
                    <div class="text-box">
                        <h4><?php echo get_phrase('expert_instruction'); ?></h4>
                        <p><?php echo get_phrase('learn_from_passionate_instructors_and_industry_experts'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 d-flex">
                <div class="home-fact-box mr-md-auto ml-auto mr-auto">
                    ...
                    <div class="text-box">
                        ...
                        <p><?php echo get_phrase('learn_at_your_own_pace_with_unlimited_access'); ?></p>
                    </div>
                </div>
            </div>
        </div>
